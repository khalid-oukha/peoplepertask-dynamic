...
?>
            ...
            <div class="row d-flex align-items-center">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 d-flex justify-content-center py-3">
                    <div class="position-relative hero-img-container ">
                        <img src="./images/heroimg.svg" alt="hero svg" id="hero-img-animation"
                        ...
                        <img src="./images/flowerm.svg" alt="icon" id="flower-small-animation"
    ...
    <section class="section-famous-freelancers my-4 py-4">
        <div class="container position-relative">
            <img src="./images/Circle2.svg" id="circles-animation1" alt="flower"
                class=" position-absolute end-0 bottom-0 ">
            <img src="./images/Circle2.svg" id="circles-animation2" alt="flower"
                class=" position-absolute end-0 bottom-10 ">
            <img src="./images/Circle4.svg" id="circles-animation3" alt="flower"
                class=" position-absolute end-0 top-10 ">
            <img src="./images/Circle4.svg" id="circles-animation4" alt="flower"
            ...
            <div class="row z-index-modifier">
                ...
                <div class=" col-lg-4 col-md-6 col-12 my-4 d-flex flex-column align-items-center freelancer-card-display"
                    style="display: none !important;">
                    <div class="card" style="max-width: 23rem;">
                        <img class="my-2 position-relative" src="images/othmanphoto.svg" alt="lahcen"
                            style="height: 9rem; ">
                        <div class="card-body ">
                            <div class="card-head">
                ...
                <div class=" col-lg-4 col-md-6 col-12 my-4 d-flex flex-column align-items-center freelancer-card-display"
                    style="display: none !important;">
                    <div class="card" style="max-width: 23rem;">
                        <img class="my-2 position-relative" src="images/ouissal.svg" alt="lahcen"
                            style="height: 9rem; ">
                        <div class="card-body ">
                            <div class="card-head">
